...
int main(int argc, char **argv) {
    ...
    string window_title("simple openGL demo");

    // this creates the window (note win is a global variable (pointer))
    win = new Window(window_size, window_title);
...
void drawFuncs::display() {
    ...
    win->displayString(str, 0.0, 0.3, colours::red);
